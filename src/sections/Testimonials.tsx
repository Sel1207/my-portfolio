...
const testimonials: Testimonial[] = [
  {
    ...
    organization: 'Mapúa University - Electrical Engineering',
    content: 'Karl Philip demonstrates exceptional dedication to his studies and a genuine passion for power systems engineering. His analytical skills and attention to detail make him stand out among his peers.',
    rating: 5,
  },
  {
    id: '2',
    ...
    role: 'Thesis Adviser',
    organization: 'Mapúa University',
    content: 'His research on adaptive power swing blocking algorithms shows remarkable innovation and technical depth. Karl has the potential to make significant contributions to the field of power system protection.',
    rating: 5,
  },
  {
    id: '3',
    ...
    organization: 'Mapúa University - Lighting Design',
    content: 'Karl\'s lighting design project for "The Pergola" mall was outstanding. He combines technical precision with creative vision, producing work that exceeds expectations.',
    rating: 5,
  },
  {
    id: '4',
    name: 'Engr. Miguel Reyes',
    role: 'Industry Mentor',
    organization: 'IIEE Philippines',
    content: 'As a DOST scholar, Karl consistently demonstrates the qualities of an excellent engineer-in-the-making. His commitment to continuous learning is truly commendable.',
    rating: 5,
  },
];
